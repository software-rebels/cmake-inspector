...
class CMakeExtractorListener(CMakeListener):
    ...
    def enterCommand_invocation_set(self, arguments):
    ...
    def enterCommand_invocation_add_definitions(self, arguments):
        addCompileOptionsCommand(arguments)

    # remove_definitions(-DFOO -DBAR ...)
    def enterCommand_invocation_remove_definitions(self, arguments):
    ...
    def enterCommand_invocation_load_cache(self, arguments):
    ...
    #                 components...]
    #                 [NO_POLICY_SCOPE])
    def enterCommand_invocation_find_package(self, arguments):
    ...
    #          [NO_POLICY_SCOPE])
    def enterCommand_invocation_include(self, arguments):
    ...
    def enterCommand_invocation_find_file(self, arguments):
        variableName = arguments.pop(0)
    ...
    def enterCommand_invocation_math(self, arguments):
    ...
    def enterCommand_invocation_add_custom_command(self, arguments):
    ...
    def enterCommand_invocation_add_test(self, arguments):
    ...
    def enterCommand_invocation_cmake_host_system_information(self, arguments):
    ...
    def enterCommand_invocation_add_custom_target(self, arguments):
        targetName = arguments.pop(0)
    ...
    def enterCommand_invocation_get_filename_component(self, arguments):
        varName = arguments.pop(0)
    ...
    #      )
    def enterCommand_invocation_build_command(self, arguments):
        varName = arguments.pop(0)
    ...
    #                FUNCTION function)
    def enterCommand_invocation_create_test_sourcelist(self, arguments):
    ...
    def enterCommand_invocation_define_property(self, arguments):
        _inherited = False
    ...
    def enterCommand_invocation_export(self, arguments):
    ...
    def enterCommand_invocation_function(self, arguments):
    ...
    def enterCommand_invocation_endmacro(self, arguments):
        vmodel.currentFunctionCommand = None

    # TODO: We didn't check for if condition. We should write a function that handles all functions like this
    def enterCommand_invocation_configure_file(self, arguments):
    ...
    #       with conditions
    def enterCommand_invocation_execute_process(self, arguments):
    ...
    def enterCommand_invocation_site_name(self, arguments):
    ...
    def enterCommand_invocation_separate_arguments(self, arguments):
    ...
    def enterCommand_invocation_cmake_minimum_required(self, arguments):
        version = arguments[1]
    ...
    #         [OUTPUT_VARIABLE var]
    #         [ARGS <arg1> <arg2>...])
    def enterCommand_invocation_try_run(self, arguments):
    ...
    #     [OUTPUT_VARIABLE <var>])
    def enterCommand_invocation_try_compile(self, arguments):
    ...
    def enterCommand_invocation_target_sources(self, arguments):
        targetName = arguments.pop(0)
    ...
    def enterCommand_invocation_target_compile_features(self, arguments):
        targetName = arguments.pop(0)
        targetInstance = lookupTable.getKey("t:{}".format(targetName))
        assert isinstance(targetInstance, TargetNode)
        features = []
    ...
    def enterCommand_invocation_target_compile_options(self, arguments):
        targetName = arguments.pop(0)
        targetInstance = lookupTable.getKey("t:{}".format(targetName))
        assert isinstance(targetInstance, TargetNode)
        options = []
    ...
    def enterCommand_invocation_set_directory_properties(self, arguments):
    ...
    def enterCommand_invocation_get_directory_property(self, arguments):
        varName = arguments.pop(0)
    ...
    def enterCommand_invocation_string(self, arguments):
    ...
    def enterCommand_invocation_get_cmake_property(self, arguments):
        varName = arguments.pop(0)
        propertyName = arguments.pop(0)
        result = []
    ...
    def enterCommand_invocation_while(self, arguments):
        whileCommand(arguments)

    def enterCommand_invocation_endwhile(self, arguments):
        endwhileCommand()

    # break()
    def enterCommand_invocation_break(self, arguments):
        breakCommand = CustomCommandNode("break")
        vmodel.nodes.append(util_handleConditions(breakCommand, breakCommand.getName()))

    # return()
    def enterCommand_invocation_return(self, arguments):
        pass

    def enterCommand_invocation_unset(self, arguments):
    ...
    def enterCommand_invocation_foreach(self, arguments):
        forEachCommand(arguments)

    def enterCommand_invocation_endforeach(self, arguments):
        lastPushedLookup = vmodel.getLastPushedLookupTable()
        state, command, level = vmodel.popSystemState()
    ...
    def enterCommand_invocation_add_library(self, arguments):
        addTarget(arguments, False)

    def enterCommand_invocation_add_executable(self, arguments):
        addTarget(arguments, True)

    def enterCommand_invocation_list(self, arguments):
        listCommand(arguments)

    def enterCommand_invocation_file(self, arguments):
        fileCommand(arguments)

    # target_include_directories( < target > [SYSTEM][BEFORE]
    #         < INTERFACE | PUBLIC | PRIVATE > [items1...]
    #       [ < INTERFACE | PUBLIC | PRIVATE > [items2...]...])
    def enterCommand_invocation_target_include_directories(self, arguments):
        targetName = arguments.pop(0)
    ...
    def enterCommand_invocation_add_compile_options(self, arguments):
        addCompileOptionsCommand(arguments)

    # link_libraries([item1 [item2 [...]]]
    #        [[debug|optimized|general] <item>] ...)
    def enterCommand_invocation_link_libraries(self, arguments):
        addLinkLibraries(arguments)

    # link_directories(directory1 directory2 ...)
    def enterCommand_invocation_link_directories(self, arguments):
        addLinkDirectories(arguments)

    def enterCommand_invocation_target_compile_definitions(self, arguments):
    ...
    def enterCommand_invocation_target_link_libraries(self, arguments):
    ...
    def enterCommand_invocation_project(self, arguments):
        projectName = arguments.pop(0)
        vmodel.langs = list(arguments)

    def enterCommand_invocation_cmake_dependent_option(self, arguments):
        optionName = arguments.pop(0)
    ...
    def enterCommand_invocation(self, ctx: CMakeParser.Command_invocationContext):
        ...
        try:
            # In cases where a single commandId string can be used to dispatch
            # we do taht here
            # Dispatched method follow naming convention def enterCommand_invocation$commandID$(self, arguments):
            # If cannot be dispatched to single string, we go to special cases below:
            handler = getattr(self, 'enterCommand_invocation_' + commandId)
            handler(arguments)

            # Here we handle special cases that cannot be easily dispatched
